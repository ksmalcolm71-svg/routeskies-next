...
export default function RouteSkies({ onBack }) {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#1b2a1b', fontFamily:"'Barlow Condensed',sans-serif", color:'#e2e8f0' }}>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .inp:focus{border-color:rgba(46,125,50,.5);background:rgba(255,255,255,0.08);}
        .inp::placeholder{color:#334155;}

        .btn-primary{background:linear-gradient(135deg,#2e7d32,#1b5e20);color:#1b2a1b;border:none;border-radius:12px;padding:14px 0;width:100%;font-family:'Barlow Condensed',sans-serif;font-size:18px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;cursor:pointer;box-shadow:0 0 32px rgba(46,125,50,0.3);transition:transform .15s,box-shadow .15s;}
        .btn-primary:hover{transform:scale(1.02);box-shadow:0 0 44px rgba(46,125,50,0.5);}
        ...
        .btn-add-stop{background:none;border:1px dashed rgba(46,125,50,0.3);border-radius:8px;color:#64748b;font-family:'Barlow Condensed',sans-serif;font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;padding:6px 14px;cursor:pointer;flex:1;transition:all .2s;}
        .btn-add-stop:hover{border-color:rgba(46,125,50,0.7);color:#2e7d32;background:rgba(46,125,50,0.06);}
        ...
        .sug-box{position:absolute;top:calc(100% + 4px);left:0;right:0;z-index:50;background:#0f1628;border:1px solid rgba(46,125,50,0.2);border-radius:10px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.5);}
        ...
        .sug-item:hover{background:rgba(46,125,50,0.1);color:#f1f5f9;}
        .sug-badge{font-size:10px;color:#2e7d32;background:rgba(46,125,50,0.12);padding:1px 6px;border-radius:4px;flex-shrink:0;}
      ...
      {/* HEADER */}
      <div className="no-print" style={{ background:'linear-gradient(180deg,#162316 0%,#1b2a1b 100%)', borderBottom:'1px solid rgba(46,125,50,0.15)', padding:'15px 20px 11px', position:'sticky', top:0, zIndex:30 }}>
        <div style={{ maxWidth:580, margin:'0 auto', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
          <div style={{ display:'flex', alignItems:'center', gap:10, cursor:onBack?'pointer':'default' }} onClick={onBack}>
            ...
            <span style={{ fontSize:21, fontWeight:900, letterSpacing:'.1em', color:'#2e7d32', textShadow:'0 0 24px rgba(46,125,50,.4)', textTransform:'uppercase' }}>RouteSkies</span>
            <span style={{ fontFamily:"'Fira Code',monospace", fontSize:9, color:'#2e7d32', background:'rgba(46,125,50,0.12)', border:'1px solid rgba(46,125,50,0.25)', padding:'2px 6px', borderRadius:4 }}>BETA</span>
          </div>
          ...
          <div className="rise">
            <div style={{ textAlign:'center', padding:'24px 0 28px' }}>
              ...
              <h1 style={{ fontSize:28, fontWeight:900, letterSpacing:'.04em', color:'#f1f5f9', lineHeight:1.2, marginBottom:8 }}>
                See weather where<br/><em style={{ color:'#2e7d32' }}>you'll actually be.</em>
              </h1>
                ...
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:10 }}>
                  <div style={{ flex:1 }}>
                    ...
                    <div style={{ fontSize:17, fontWeight:800, color:'#f1f5f9' }}>
                      ...
                      <span style={{ color:'#2e7d32', margin:'0 6px' }}>→</span>
              ...
              <div>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:8 }}>
                  {ROUTE_OPTS.map(o => {
                    ...
                    return (
                      <button key={o.id} className="route-pill" onClick={() => setRouteType(o.id)} style={{ background:active?'rgba(46,125,50,0.12)':'rgba(255,255,255,0.04)', border:active?'1px solid rgba(46,125,50,0.5)':'1px solid rgba(255,255,255,0.08)', color:active?'#2e7d32':'#64748b' }}>
            ...
            <div style={{ marginTop:16, padding:'10px 14px', borderRadius:10, background:'rgba(46,125,50,0.04)', border:'1px solid rgba(46,125,50,0.09)', textAlign:'center' }}>
          ...
          <>
            {loading && (
              <div style={{ textAlign:'center', padding:'48px 20px' }}>
                <div style={{ width:40, height:40, border:'3px solid rgba(46,125,50,0.2)', borderTop:'3px solid #2e7d32', borderRadius:'50%', margin:'0 auto 16px' }} className="spin" />
                <div style={{ color:'#2e7d32', fontSize:13, fontFamily:"'Fira Code',monospace", letterSpacing:'.06em' }}>Planning your route...</div>
              ...
              <div className="rise" style={{ background:'rgba(255,255,255,0.03)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:14, padding:'13px 16px', marginBottom:14, display:'flex', flexWrap:'wrap', gap:8, alignItems:'center', justifyContent:'space-between' }}>
                <div>
                  <div style={{ fontSize:18, fontWeight:800, color:'#f1f5f9' }}>
                    {origin.split(',')[0]} <span style={{ color:'#2e7d32' }}>→</span> {dest.split(',')[0]}
                  </div>
                  <div style={{ fontFamily:"'Fira Code',monospace", fontSize:11, color:'#64748b', marginTop:2 }}>
              ...
              <div className="no-print rise" style={{ display:'flex', gap:4, marginBottom:14, background:'rgba(255,255,255,0.03)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:12, padding:4 }}>
                {[
                  ...
                  <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{
                    ...
                    transition:'all .2s',
                    background: activeTab===tab.id ? 'rgba(46,125,50,0.15)' : 'transparent',
                    color:      activeTab===tab.id ? '#2e7d32' : '#475569',
                    boxShadow:  activeTab===tab.id ? 'inset 0 0 0 1px rgba(46,125,50,0.3)' : 'none',
                  }}>
                    {tab.label}
                  </button>
                ))}
                      ...
                      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                        <div style={{ flex:1 }}>
                          <div style={{ display:'flex', alignItems:'center', gap:5, marginBottom:3, flexWrap:'wrap' }}>
                            ...
                            {wp.isStart && <span style={{ fontSize:9, fontWeight:800, color:'#2e7d32', letterSpacing:'.08em' }}>START</span>}
              ...
              <div className="rise" style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:14, overflow:'hidden' }}>
                {directions.map((step, i) => (
                  <div key={i} style={{ display:'flex', gap:12, padding:'11px 14px', borderBottom: i < directions.length-1 ? '1px solid rgba(255,255,255,0.05)' : 'none', alignItems:'flex-start' }}>
                    <div style={{ width:30, height:30, borderRadius:'50%', background:'rgba(46,125,50,0.08)', border:'1px solid rgba(46,125,50,0.18)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0, fontSize:14, color:'#2e7d32' }}>
            ...
            {!loading && stops.length>0 && (
              <div style={{ marginTop:12, padding:'10px 14px', borderRadius:10, background:'rgba(46,125,50,0.03)', border:'1px solid rgba(46,125,50,0.08)', textAlign:'center' }}>
                <div style={{ fontSize:10, color:'#334155', fontFamily:"'Fira Code',monospace", lineHeight:1.8 }}>
